                          ...
                          <form class="needs-validation" method="POST" enctype="multipart/form-data">
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-6 mb-2">
                                  ...
                                  <input type="number" class="form-control" id="" name="edit_memo_number"
                                    value="<?php echo $erow['memo_number']; ?>"
                                    placeholder="<?php echo $erow['memo_number']; ?>" readonly>
                                ...
                                <div class="col-md-6 mb-2">
                                  ...
                                  <input type="date" class="form-control" id="" name="edit_date"
                                    value="<?php echo $erow['date']; ?>" required>
                                  <div class="valid-feedback">
                                    Looks good!
                                  </div>
                                </div>
                            ...
                            <div class="row">
                              <div class="dropdown col-md-6 mb-2">
                                ...
                                <select class="form-select" placeholder="<?php echo $erow['from'] ?>" name="edit_from"
                                  value="">
                                  ...
                                  <option value="College of Engineering, Dean">College of Engineering and Architecture,
                                    Dean</option>
                                </select>
                              </div>
